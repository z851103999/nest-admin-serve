...
--
-- Host: 127.0.0.1    Database: nest-admin
-- ------------------------------------------------------
...
CREATE TABLE `sys_config` (
  ...
  `key` varchar(50) COLLATE utf8mb4_general_ci NOT NULL COMMENT '参数配置键',
  `name` varchar(50) COLLATE utf8mb4_general_ci NOT NULL COMMENT '参数配置名称',
  `value` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '参数配置值',
  `remark` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '参数配置备注',
  PRIMARY KEY (`id`),
  UNIQUE KEY `IDX_2c363c25cf99bcaab3a7f389ba` (`key`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统参数配置表';
...
CREATE TABLE `sys_department` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统部门';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_login_log` (
  ...
  `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `user_id` int DEFAULT NULL COMMENT '登录的用户id',
  `ip` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '登录ip',
  `time` datetime DEFAULT NULL COMMENT '登录时间',
  `ua` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'user-agent',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='登录日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_menu` (
  ...
  `name` varchar(255) COLLATE utf8mb4_general_ci NOT NULL COMMENT '菜单名称',
  `router` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '菜单地址',
  ...
  `icon` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '对应图标',
  `order_num` int DEFAULT '0' COMMENT '排序',
  `view_path` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '视图地址，对应vue文件',
  `keepalive` tinyint DEFAULT '1' COMMENT '路由缓存',
  `is_show` tinyint DEFAULT '1' COMMENT '是否显示在菜单栏',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=92 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统菜单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_req_log` (
  ...
  `method` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status` int DEFAULT NULL,
  `consume_time` int DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='请求记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_role` (
  ...
  `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `user_id` varchar(255) COLLATE utf8mb4_general_ci NOT NULL COMMENT '创建人',
  `name` varchar(255) COLLATE utf8mb4_general_ci NOT NULL COMMENT '名称',
  `label` varchar(50) COLLATE utf8mb4_general_ci NOT NULL COMMENT '标签',
...
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统角色';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_role_department` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统角色部门关系';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_role_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=155 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统角色菜单关系';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_task` (
  ...
  `service` varchar(255) COLLATE utf8mb4_general_ci NOT NULL COMMENT '需要执行的service',
  `type` tinyint NOT NULL DEFAULT '0' COMMENT '任务模式：0位cron,1为时间间隔',
  `status` tinyint NOT NULL DEFAULT '1' COMMENT '任务状态，0为停止，1位运行',
  `start_time` datetime DEFAULT NULL COMMENT '任务开始时间，type为0时生效',
  `end_time` datetime DEFAULT NULL COMMENT '任务结束时间，type为0时生效',
  `limit` int DEFAULT '0' COMMENT '最大执行次数，小于或者等于0，不限次数',
  `cron` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'cron表达式，type为0时生效',
  `every` int DEFAULT NULL COMMENT '执行间隔，type为1时生效',
  `data` text COLLATE utf8mb4_general_ci COMMENT '传入数据',
  `job_opts` text COLLATE utf8mb4_general_ci COMMENT 'bull job 选项',
  `remark` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`),
  UNIQUE KEY `IDX_ef8e5ab5ef2fe0ddb1428439ef` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统任务表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_task_log` (
  ...
  `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `task_id` int NOT NULL COMMENT '对应任务id',
  `status` tinyint NOT NULL DEFAULT '0' COMMENT '任务状态：0为失败，1为成功',
  `detail` text COLLATE utf8mb4_general_ci COMMENT '任务详情',
  `consume_time` int DEFAULT '0' COMMENT '任务完成耗时ms',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='任务日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_user` (
  ...
  `phone` varchar(255) COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '手机',
  `remark` varchar(255) COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '备注',
  `psalt` varchar(32) COLLATE utf8mb4_general_ci NOT NULL COMMENT '密码盐值',
  `status` tinyint DEFAULT '1' COMMENT '状态 0 禁用 1启用',
  PRIMARY KEY (`id`),
  UNIQUE KEY `IDX_9e7164b2f1ea1348bc0eb0a7da` (`username`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统用户';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_user_role` (
  ...
  `role_id` int NOT NULL COMMENT '角色ID',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=67 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统用户角色关系';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-10-11 18:13:52
